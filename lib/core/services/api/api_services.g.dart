...
class _ApiService implements ApiService {
  ...
  Future<VerificationCodeResponseModel> verifyResetCode(
    VerificationCodeRequestModel forgotPasswordRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(forgotPasswordRequest.toJson());
    final _options = _setStreamType<VerificationCodeResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VerificationCodeResponseModel _value;
    try {
      _value = VerificationCodeResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<MessageResponseModel> clearCart(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<AddressResponseModel> getAddresses(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<List<OrderResponseModel>> getUserOrders(String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<PaymentIntentResponseModel> createPaymentIntent(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<PaymentIntentResponseModel>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
