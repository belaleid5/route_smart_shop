...
class MyColors extends ThemeExtension<MyColors> {
  ...
  static final MyColors light = MyColors(
  ...
  static final MyColors dark = MyColors(
  ...
  MyColors copyWith({
    ...
    Color? shimmerHighlight,
      ...
      MyColors(
        ...
        surface: surface ?? this.surface,        // ← جديد
  ...
  MyColors lerp(ThemeExtension<MyColors>? other, double t) {
    ...
    return MyColors(
      ...
      surface: Color.lerp(surface, other.surface, t)!,        // ← جديد
