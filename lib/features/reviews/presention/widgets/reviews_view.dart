...
import 'package:route_smart/features/reviews/presention/widgets/reviews_listener.dart';
import 'package:route_smart/features/reviews/presention/widgets/reviews_builder.dart';
...
class _ReviewsViewState extends State<ReviewsView> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ReviewsBloc, ReviewsState>(
      ...
      builder: (context, state) => ReviewsBuilder.build(
        context,
        state,
        widget.productId,
        _userIdFuture,
