// lib/features/search/presentation/manager/search_params.dart
...
class SearchFilterParams {
  ...
  SearchFilterParams copyWith({
    ...
    return SearchFilterParams(
      ...
      // ✅ identical() أدق من == مع الـ sentinel
      ...
      fields:     identical(fields, _sentinel)     
          ? this.fields
          : fields as String?,
    );
  }
  ...
  @override
  String toString() => 'SearchFilterParams('
      'keyword: $keyword, '
      'page: $page, '
      'tab: $activeTab, '
      'category: $categoryId, '
